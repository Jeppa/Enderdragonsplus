...
public class LimitedEnderDragonVersionManager {
	...
	public static LimitedED generate(Location loc, String ageName){
		if(EnderdragonsPlus.getRelocationAddition().equalsIgnoreCase("1_11_R1")){
			return new de.tobiyas.enderdragonsplus.entity.dragon.v1_11_1.LimitedEnderDragon(loc, loc.getWorld(), ageName);
		}
	...
	public static boolean isCurrentVersionSupported(){
		...
		if(support.equalsIgnoreCase("1_11_R1")) return true;
	...
	public static Class<?> getCurrentClass(){
		String support = EnderdragonsPlus.getRelocationAddition();
		if(support.equalsIgnoreCase("1_11_R1")) return de.tobiyas.enderdragonsplus.entity.dragon.v1_11_1.LimitedEnderDragon.class;
	...
	public static boolean replaceEntityWithEDPDragon(EnderDragon oldDragon, String ageName){
		String support = EnderdragonsPlus.getRelocationAddition();
		if(support.equalsIgnoreCase("1_11_R1")) return de.tobiyas.enderdragonsplus.entity.dragon.v1_11_1.LimitedEnderDragon.replaceEntityWithEDPDragon(oldDragon, ageName);
